...
/**
 * ServerMultithread class for blackjack game handles all the server side logic for the game
 *
...
class ClientHandler extends Thread {
  ...
  /**
   * Gets the hand value for the dealer Standard house rules, if the dealer has a value less than
   * 17, he hits or hits until busts or has a greater value than the player
   *
